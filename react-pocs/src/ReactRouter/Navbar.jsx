...
function Navbar() {
    return (
        <div className="div1">
            ...
            {/* <div><NavLink activeClassName="testClass" to='/ConditionalRendering'>ConditionalRendering</NavLink></div> */}
            <div><NavLink activeClassName="testClass" to='/EmpSalaryComp'>EmpSalaryComp</NavLink></div>
            ...
            <div><NavLink activeClassName="testClass" to='/ProductCartRedux'>ProductCartRedux</NavLink></div>
